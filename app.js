...
let url = 'https://www.omdbapi.com/?apikey=' + apikey;
        ...
        if ($('button#' + `${searchId}`).hasClass('visited')) {
            ...
            $.ajax({
                ...
                success: (res) => {
                    ...
                    let seasons = (seasonsNo !== undefined) ? `<tr class="row${searchId}"><td>Broj sezona:</td><td>${seasonsNo}</td></tr>` : '';
    ...
    function hideInfo(btnId2) {
        ...
        let trId = btnId2.replace('btn1', 'row');
